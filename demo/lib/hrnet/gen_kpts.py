...
def parse_args():
    ...
    # general
    parser.add_argument('--cfg', type=str, default='../demo/lib/hrnet/experiments/w48_384x288_adam_lr1e-3.yaml',
                        help='experiment configure file name')
    parser.add_argument('--pre', type=str, default="../checkpoint/h36m/ckpt_h36m.pth.tar", help='pre model')
    parser.add_argument('opts', nargs=argparse.REMAINDER, default=None,
                        help="Modify config options using the command-line")
    parser.add_argument('--modelDir', type=str, default='../demo/lib/checkpoint/pose_hrnet_w48_384x288.pth',
